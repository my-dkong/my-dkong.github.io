...
if(sessionStorage.getItem("IDUSER")!==null){
  ...
  for(var i=0;i<levels.content.levels.length;i++){
    event.select(".levels").innerHTML+='<div class="gd-box-level"><img class="gd-img'+i+'" src="gd-icons/icon'+i+'.png" alt="Icône Geometry Dash n°'+(i+1)+'"><br>GD '+(levels.content.levels[i].levels.join(", ")+".")+'</div>';
  }
